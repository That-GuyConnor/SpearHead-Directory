...
-- Ammo
wepStats.ammoType = "7.62×39mm" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
...
wepStats.gunRecoil = {
	...
	punchMultiplier = 0.7, -- How much the gun moves back during recoil
}
