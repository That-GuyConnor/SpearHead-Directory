...
wepStats.muzzleVelocity = 884 -- this stat uses meters per second
wepStats.aimSpeed = 0.3 -- 0-1 how much should the aim speed be multiplied by
wepStats.gunLength = 3.2 -- How close you can get to a surface before the viewmodel moves back
...
-- Ammo
wepStats.ammoType = "5.56x45mm" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
...
-- Viewmodel
wepStats.viewmodelOffset = CFrame.new(0.2,0.1,-0.3) -- Where should the viewmodel be placed in reference to the camera
...
wepStats.reloadAnim = "Rifle_Reload"
wepStats.boltChamber = "Rifle_Chamber" -- Plays if the bolt is closed
wepStats.boltClose = "Rifle_Close" -- Plays if the bolt is open
